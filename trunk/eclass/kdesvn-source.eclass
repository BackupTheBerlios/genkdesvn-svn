...
inherit kdesvn-repo kdesvn-make
...
function kdesvn-source_src_unpack {
...
function kdesvn-source_pkg_setup {

	kdesvn-make_pkg_setup
	[ "`type -t kdesvn_pkg_setup`" == "function" ] && kdesvn_pkg_setup
