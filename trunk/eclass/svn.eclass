...
## -- ESVN_PATCHES:
#
# subversion eclass can apply pathces in svn_bootstrap().
...
function svn_src_unpack() {
	...
	svn_svn_fetch || die "${ESVN}: unknown problem in svn_svn_fetch()."
	svn_bootstrap || die "${ESVN}: unknown problem in svn_bootstrap()."
